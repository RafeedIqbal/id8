...
export const NODE_LABELS: Record<string, string> = {
  ...
  GenerateTechPlan: "Generate Tech Plan",
  WaitTechPlanApproval: "Tech Plan Approval",
...
export const STATUS_CONFIG: Record<ProjectStatus, { label: string; color: string; bg: string }> = {
  ...
  tech_plan_draft: { label: "Tech Plan", color: "var(--color-info)", bg: "var(--color-info-bg)" },
  tech_plan_approved: { label: "Plan OK", color: "var(--color-success)", bg: "var(--color-success-bg)" },
